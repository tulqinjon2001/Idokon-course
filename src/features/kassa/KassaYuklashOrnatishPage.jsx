...
import TelegramPost from "../../shared/components/media/TelegramPost";
import VideoPlayer from "../../shared/components/media/VideoPlayer.jsx";

export default function KassaYuklashOrnatishPage() {
  ...
  const CassaVersionURL =
    "https://github.com/tulqinjon2001/Idokon-course/releases/download/Kassa/Idokon1.3.9.x64.exe";
